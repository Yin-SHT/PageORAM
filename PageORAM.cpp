...
{   
    ...
    std::cout << "Please enter path of benchmark trace file: ";
    std::cin >> fileName;
    std::cout << std::endl;
    fin.open(fileName);
    //std::getline(fin, a);
    ...
    std::cout << "Enter the configuration (0 for PageORAM, 1 for baseline-1, 2 for baseline-2 and 3 for baseline-3): ";
    int baseline;
    std::cin >> baseline;
    std::cout << std::endl;
    if(baseline == 0)
    ...
    if(baseline == 1)
        std::cout << "The configuration chosen is baseline-1" << std::endl;

    if(baseline == 2)
        std::cout << "The configuration chosen is baseline-2" << std::endl;

    if(baseline == 3)
        std::cout << "The configuration chosen is baseline-3" << std::endl;
    //std::cout<<"yolo" << std::endl;
    ...
    std::cout << "Number of dummy reads is " << dummy << std::endl;
